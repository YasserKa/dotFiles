local config = {
  ...
  mappings = {
    ...
    n = {
      ...
      ["q;"] = { "q:" },
      ["@;"] = { "@;" },
      ["<leader>es"] = { "<cmd>split ~/.config/nvim/init.lua<cr>", desc = "Split config file" },
  ...
  polish = function()
    ...
    _G.YankOrgLink =
      function() vim.fn.setreg("+", "[[" .. vim.fn.expand "%:p" .. "][" .. vim.fn.expand "%:t" .. "]]") end
    ...
    -- vim.keymap.set("n", "gl", "`[v`]", { expr = true })
    --
