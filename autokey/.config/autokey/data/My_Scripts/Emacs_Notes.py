...
system.exec_command(
    f'i3-msg "[title="{NAME}"] floating enable, move container workspace current move'
    ' position center"'
)
...
if retCode:
    system.exec_command(
        f'i3-msg "[title="{NAME}"] move --no-auto-back-and-forth container workspace'
        f' {workspace_num}, floating disable"'
    )
