...
c.aliases = {
    ...
    "get_paper_citations": 'spawn bash -ic "~/bin/helpers/notify_paper_citation {url}"',
    "get_paper_graph": 'spawn bash -ic "xdg-open https://inciteful.xyz/p/$(get_paper_metadata DOI {url})"',
