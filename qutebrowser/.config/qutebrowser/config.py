...
c.bindings.commands = {
    "normal": {
        ...
        "<Alt-c><space>c": (
            "spawn --userscript ~/.config/qutebrowser/userscripts/qute_org_capture --template=clock"
        ),
        "<Alt-r><space>c": (
            "spawn --userscript ~/.config/qutebrowser/userscripts/qute_org_capture --template=refile"
        ),
